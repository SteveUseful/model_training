...
# Drop 'CustomerID' and 'ChurnRiskReason' as these should not be used for model training
df.drop(['CustomerID', 'ChurnRiskReason'], axis=1, inplace=True)

# Identify numerical features and target variable
numerical_features = ['ProductCustomerFitScore', 'OnboardingCompletion', 'CustomerServiceRating', 
...
# Create a pipeline with scaler and a placeholder for the model
pipeline = Pipeline(steps=[('scaler', scaler), ('model', None)])
